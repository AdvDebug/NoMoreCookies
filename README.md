...
and it should work against other popular stealers. and please note that this protection doesn't only work with these listed above, it will work with feature stealers as well as this protection is universal and not targeted against a specific kind of malware.
